...
## [1.4.0](https://github.com/stungkit/nvim-tree.lua/compare/nvim-tree-v1.18.0...nvim-tree-v1.4.0) (2026-09-21)
...
* **#1549:** p will paste files from another nvim-tree instance, gp will cut/paste ([#3336](https://github.com/stungkit/nvim-tree.lua/issues/3336)) ([c760c92](https://github.com/stungkit/nvim-tree.lua/commit/c760c92667fe5febf99e2a5bb8a543b0208c743b))
...
* **#1851:** add bookmarks.persist, default path: vim.fn.stdpath("data") .. "/nvim-tree-bookmarks.json", disabled by default ([#3033](https://github.com/stungkit/nvim-tree.lua/issues/3033)) ([c89215d](https://github.com/stungkit/nvim-tree.lua/commit/c89215d6a1107a3c0c134750be48657ba8e6a9aa))
...
* **#2819:** add actions.open_file.relative_path, default enabled, following successful experiment ([#2995](https://github.com/stungkit/nvim-tree.lua/issues/2995)) ([2ee1c5e](https://github.com/stungkit/nvim-tree.lua/commit/2ee1c5e17fdfbf5013af31b1410e4a5f28f4cadd))
...
* **#2994:** add visual mode operations: copy, cut, delete, trash, toggle bookmark ([#3268](https://github.com/stungkit/nvim-tree.lua/issues/3268)) ([9197f3e](https://github.com/stungkit/nvim-tree.lua/commit/9197f3ee3f0c9a754aab5b16500db6d7da5f68fd))
* **#2994:** add visual selection operations ([9197f3e](https://github.com/stungkit/nvim-tree.lua/commit/9197f3ee3f0c9a754aab5b16500db6d7da5f68fd))
...
* **#3213:** add `view.width.lines_excluded` option ([776a5cd](https://github.com/stungkit/nvim-tree.lua/commit/776a5cdfac948b490e06f1d1d22c4cb986e40699))
* **#3213:** add view.width.lines_excluded option ([#3214](https://github.com/stungkit/nvim-tree.lua/issues/3214)) ([776a5cd](https://github.com/stungkit/nvim-tree.lua/commit/776a5cdfac948b490e06f1d1d22c4cb986e40699))
* **#3292:** add nvim_tree.config.filesystem_watchers.whitelist_dirs - strongly recommended for windows ([#3298](https://github.com/stungkit/nvim-tree.lua/issues/3298)) ([6eaf74c](https://github.com/stungkit/nvim-tree.lua/commit/6eaf74c9919d121d2806ac3c20e757e66bd29c31))
* **#3310:** minimum neovim version 0.10 ([#3311](https://github.com/stungkit/nvim-tree.lua/issues/3311)) ([7adc567](https://github.com/stungkit/nvim-tree.lua/commit/7adc5679feb439275255aa9e95c434cca206d10c))
* add &lt;Del&gt; mapping ([ca8d82f](https://github.com/stungkit/nvim-tree.lua/commit/ca8d82fff26cb12ced239713e3222f4a9dcd0da0))
...
* add default &lt;Del&gt; mapping for api.fs.remove ([#3238](https://github.com/stungkit/nvim-tree.lua/issues/3238)) ([ca8d82f](https://github.com/stungkit/nvim-tree.lua/commit/ca8d82fff26cb12ced239713e3222f4a9dcd0da0))
...
* enable experimental.session_restore_nvim by default ([#3356](https://github.com/stungkit/nvim-tree.lua/issues/3356)) ([8d81449](https://github.com/stungkit/nvim-tree.lua/commit/8d814495983e8db87d02d2f1da293f25b2fd1bdc))
* enable session restore by default ([8d81449](https://github.com/stungkit/nvim-tree.lua/commit/8d814495983e8db87d02d2f1da293f25b2fd1bdc))
* experiment: restore nvim-tree on session load, see https://github.com/nvim-tree/nvim-tree.lua/issues/3343 ([#3335](https://github.com/stungkit/nvim-tree.lua/issues/3335)) ([cf18a66](https://github.com/stungkit/nvim-tree.lua/commit/cf18a662cd5f200361b6fedfb794eed583e075e1))
...
* **icon_placement:** Allow right_align icon_placemente for decorator using ext_marks nvim api ([e25eb7f](https://github.com/stungkit/nvim-tree.lua/commit/e25eb7fa83f7614bb23d762e91d2de44fcd7103b))
* **icon_placement:** Allow right_align icon_placemente for decorator using ext_marks nvim api ([e25eb7f](https://github.com/stungkit/nvim-tree.lua/commit/e25eb7fa83f7614bb23d762e91d2de44fcd7103b))
* **icon_placement:** Allow right_align icon_placemente for decorator using ext_marks nvim api ([48d0e82](https://github.com/stungkit/nvim-tree.lua/commit/48d0e82f9434691cc50d970898142a8c084a49d6))
* **icon_placement:** Allow right_align icon_placemente for decorator using ext_marks nvim api ([1d629a5](https://github.com/stungkit/nvim-tree.lua/commit/1d629a5d3f7d83d516494c221a2cfc079f43bc47))
* load command definitions at nvim startup ([#3211](https://github.com/stungkit/nvim-tree.lua/issues/3211)) ([1eda256](https://github.com/stungkit/nvim-tree.lua/commit/1eda2569394f866360e61f590f1796877388cb8a))
* load command definitions in `plugin` directory ([1eda256](https://github.com/stungkit/nvim-tree.lua/commit/1eda2569394f866360e61f590f1796877388cb8a))
...
* use `add_trailing` also for symlink destination ([81ede55](https://github.com/stungkit/nvim-tree.lua/commit/81ede55c47528ff7c81b2a498fbee61b298c4e2f))


### Bug Fixes

* "invalid 'line'" when hidden_display is set and tree is empty ([#3354](https://github.com/stungkit/nvim-tree.lua/issues/3354)) ([882c54f](https://github.com/stungkit/nvim-tree.lua/commit/882c54f2815bf6d02663d482c2cf9dbadf4e9b07))
...
* **##3288:** restore single-item paste conflict prompts ([#3289](https://github.com/stungkit/nvim-tree.lua/issues/3289)) ([b3772ad](https://github.com/stungkit/nvim-tree.lua/commit/b3772adec8db61ba9098c5624a0823a77be3a23d))
...
* **#2758:** use nvim-webdevicons default for default files ([347e1eb](https://github.com/stungkit/nvim-tree.lua/commit/347e1eb35264677f66a79466bb5e3d111968e12c))
...
* **#2972:** error on :colorscheme ([#2973](https://github.com/stungkit/nvim-tree.lua/issues/2973)) ([6e5a204](https://github.com/stungkit/nvim-tree.lua/commit/6e5a204ca659bb8f2a564df75df2739edec03cb0))
...
* **#3178:** handle Windows paths in ignore_dirs and add .zig-cache to defaults ([#3261](https://github.com/stungkit/nvim-tree.lua/issues/3261)) ([5499299](https://github.com/stungkit/nvim-tree.lua/commit/5499299746b95c49ef4fc89b30c29a79b577881f))
* **#3187:** prevent closing the last non-floating window when deleting files ([#3282](https://github.com/stungkit/nvim-tree.lua/issues/3282)) ([018a078](https://github.com/stungkit/nvim-tree.lua/commit/018a078c1e149bcd0c4e65c92aabb8e12501d769))
* **#3198:** add filesystem_watchers.max_events to handle runaway filesystem events on PowerShell ([#3232](https://github.com/stungkit/nvim-tree.lua/issues/3232)) ([c07ce43](https://github.com/stungkit/nvim-tree.lua/commit/c07ce43527e5f0242121f4eb1feb7ac0ecea8275))
* **#3226:** set &swapfile=false before setting tree buffer name, avoiding any potential collisions with a swapfile ([#3227](https://github.com/stungkit/nvim-tree.lua/issues/3227)) ([8298117](https://github.com/stungkit/nvim-tree.lua/commit/8298117311a1f23f039c278e4e4977ab80a15e33))
* **#3248:** bookmark filter shows contents of marked directories ([#3249](https://github.com/stungkit/nvim-tree.lua/issues/3249)) ([5757bcf](https://github.com/stungkit/nvim-tree.lua/commit/5757bcf0447d22d8f78826bc5c59b28da2824c3b))
* **#3251:** pass git.timeout to all vim.system git calls ([#3277](https://github.com/stungkit/nvim-tree.lua/issues/3277)) ([e49b0d9](https://github.com/stungkit/nvim-tree.lua/commit/e49b0d9bfa70989cf8b5abf5557f51e6e57f68d6))
* **#3257:** error when calling api.tree.find_file ([#3304](https://github.com/stungkit/nvim-tree.lua/issues/3304)) ([b548cfe](https://github.com/stungkit/nvim-tree.lua/commit/b548cfef00a79f0b3e3af24f91ae6bd14f22af95))
* **#3265:** rename module api.health to api.appearance, to avoid :checkhealth detection ([#3266](https://github.com/stungkit/nvim-tree.lua/issues/3266)) ([1df1960](https://github.com/stungkit/nvim-tree.lua/commit/1df1960d0e3a26643a4100f64fa03b991b9f4b85))
* **#3267:** renderer.icons.*_placement 'right_align' at the right hand edge, not the right of the name ([#3270](https://github.com/stungkit/nvim-tree.lua/issues/3270)) ([fa3c458](https://github.com/stungkit/nvim-tree.lua/commit/fa3c45875f9b1f56ace57711c6f2ac22484ed956))
* **#3281:** fix a bug when a view width of -1 is returned from a function ([#3283](https://github.com/stungkit/nvim-tree.lua/issues/3283)) ([c988e28](https://github.com/stungkit/nvim-tree.lua/commit/c988e289428d9202b28ba27479647033c7dd2956))
* **#3293:** marks.bulk operations filter descendant nodes ([#3294](https://github.com/stungkit/nvim-tree.lua/issues/3294)) ([f37ebac](https://github.com/stungkit/nvim-tree.lua/commit/f37ebac81164e1445c499cdd6de86e6d8e5d57e4))
* **#3301:** setup with empty config fails ([#3303](https://github.com/stungkit/nvim-tree.lua/issues/3303)) ([ec0efb0](https://github.com/stungkit/nvim-tree.lua/commit/ec0efb06b0abfa56492acfc8c34ac8958d18601e))
* **#3312:** correct cursor when full name shown, requires nvim 0.12.2+ ([#3316](https://github.com/stungkit/nvim-tree.lua/issues/3316)) ([d277467](https://github.com/stungkit/nvim-tree.lua/commit/d277467fc0d1d0e2bca88165a1de6b526f9f6fe8))
* **#3324:** deprecated BufModifiedSet event replaced by OptionSet event for Nvim 0.13+ ([#3325](https://github.com/stungkit/nvim-tree.lua/issues/3325)) ([f9bfc00](https://github.com/stungkit/nvim-tree.lua/commit/f9bfc0059eca24546b69a7006110463da4808f8f))
* **#3327:** pass nvim_tree.api.node.open.Opts to all applicable nvim_tree.api.node.open function ([#3329](https://github.com/stungkit/nvim-tree.lua/issues/3329)) ([07f541f](https://github.com/stungkit/nvim-tree.lua/commit/07f541fcaa4a5ae019598240362449ab7e9812b3))
* **#3346:** api.tree.resize: 'configure_width' (a nil value) ([#3347](https://github.com/stungkit/nvim-tree.lua/issues/3347)) ([a797d5e](https://github.com/stungkit/nvim-tree.lua/commit/a797d5e20133fc031fba4aa7d1272f5b1d950a1c))
* **#925:** handle newlines in file names ([#2754](https://github.com/stungkit/nvim-tree.lua/issues/2754)) ([64f61e4](https://github.com/stungkit/nvim-tree.lua/commit/64f61e4c913047a045ff90bd188dd3b54ee443cf))
* allow 0 (unlimited) filesystem_watchers.max_events which is the new default, except for windows at 1000 ([#3279](https://github.com/stungkit/nvim-tree.lua/issues/3279)) ([87594aa](https://github.com/stungkit/nvim-tree.lua/commit/87594aa7c8808701b418b285e9adf690acead201))
...
* api.tree.change_root_to_node on a file now changes directory to parent as per documentation ([#3228](https://github.com/stungkit/nvim-tree.lua/issues/3228)) ([b8b44b6](https://github.com/stungkit/nvim-tree.lua/commit/b8b44b6a2494d086a9177251a119f9daec6cace8))
...
* correctly assign extmarks to lines when computing tree window width in `grow` when `nvim-tree.view.width.lines_excluded` contains "root" ([e66994d](https://github.com/stungkit/nvim-tree.lua/commit/e66994d40db2d57c91bf9aeaee8bf7ab8b1131f6))
...
* **full-name:** lower `zindex` to get consistent cursor shape ([d277467](https://github.com/stungkit/nvim-tree.lua/commit/d277467fc0d1d0e2bca88165a1de6b526f9f6fe8))
...
* incorrect window width when right_align icons present ([#3239](https://github.com/stungkit/nvim-tree.lua/issues/3239)) ([e66994d](https://github.com/stungkit/nvim-tree.lua/commit/e66994d40db2d57c91bf9aeaee8bf7ab8b1131f6))
* increase filesystem_watchers.max_events from 100 to 1000 ([#3263](https://github.com/stungkit/nvim-tree.lua/issues/3263)) ([0f4d2d6](https://github.com/stungkit/nvim-tree.lua/commit/0f4d2d6998dc324d54d6adce94186bee43725afb))
...
* null deref in case git.config is empty ([#3351](https://github.com/stungkit/nvim-tree.lua/issues/3351)) ([b2aadda](https://github.com/stungkit/nvim-tree.lua/commit/b2aadda94b107480c48e548d6db51c6840b7b33c))
...
* renderer.add_trailing applies to symlink destination ([#3217](https://github.com/stungkit/nvim-tree.lua/issues/3217)) ([81ede55](https://github.com/stungkit/nvim-tree.lua/commit/81ede55c47528ff7c81b2a498fbee61b298c4e2f))
* restore bookmark filter for marked directories ([5757bcf](https://github.com/stungkit/nvim-tree.lua/commit/5757bcf0447d22d8f78826bc5c59b28da2824c3b))
...
* set buffer option before set_buf_name ([8298117](https://github.com/stungkit/nvim-tree.lua/commit/8298117311a1f23f039c278e4e4977ab80a15e33))
...
* symlink file icons rendered when renderer.icons.show.file = false, folder.symlink* was incorrectly rendered as folder.default|open ([#2983](https://github.com/stungkit/nvim-tree.lua/issues/2983)) ([2156bc0](https://github.com/stungkit/nvim-tree.lua/commit/2156bc08c982d3c4b4cfc2b8fd7faeff58a88e10))
* system open native requires nvim 0.10 ([#3309](https://github.com/stungkit/nvim-tree.lua/issues/3309)) ([02ccbcd](https://github.com/stungkit/nvim-tree.lua/commit/02ccbcd4af9a7fa159251f721d763c0d16f91703))
...
* wrong behavior for api.tree.change_root_to_node ([b8b44b6](https://github.com/stungkit/nvim-tree.lua/commit/b8b44b6a2494d086a9177251a119f9daec6cace8))
...
* **#3231:** decrease setup time: optimise setup and defer requires until tree open ([#3308](https://github.com/stungkit/nvim-tree.lua/issues/3308)) ([31503ad](https://github.com/stungkit/nvim-tree.lua/commit/31503ad5d869fca61461d82a9126f62480ecb0ab))
* **#3257:** remove setup for actions modules, full-name and explorer ([#3299](https://github.com/stungkit/nvim-tree.lua/issues/3299)) ([43a3bb4](https://github.com/stungkit/nvim-tree.lua/commit/43a3bb4b26b4578a704f24bb6a4889b454c0eb65))
* **#3257:** remove setup for modules: buffers, diagnostics, git, help, keymap, lib, watcher ([#3295](https://github.com/stungkit/nvim-tree.lua/issues/3295)) ([3d385d3](https://github.com/stungkit/nvim-tree.lua/commit/3d385d3346e4883d60dc37cf642bd47bed78a46e))
* **#3257:** remove setup for renderer, log, appearance ([#3307](https://github.com/stungkit/nvim-tree.lua/issues/3307)) ([3603f06](https://github.com/stungkit/nvim-tree.lua/commit/3603f069ff783c31986894a56c2a6755331b0802))
* **#3257:** remove setup for view, extracting view-state ([#3306](https://github.com/stungkit/nvim-tree.lua/issues/3306)) ([4cbe795](https://github.com/stungkit/nvim-tree.lua/commit/4cbe79526f8bc0bdb1a500d261dc5cc1be4e77d5))
* **#3284:** re-draw instead of refreshing the tree when a buffer is modified ([#3285](https://github.com/stungkit/nvim-tree.lua/issues/3285)) ([c8d8d51](https://github.com/stungkit/nvim-tree.lua/commit/c8d8d515c29f0f0b1a352e0d75616f74f42fc03b))
* **commands:** defer module loading ([#3210](https://github.com/stungkit/nvim-tree.lua/issues/3210)) ([68c67ad](https://github.com/stungkit/nvim-tree.lua/commit/68c67adfabfd1ce923839570507ef2e81ab8a408))
